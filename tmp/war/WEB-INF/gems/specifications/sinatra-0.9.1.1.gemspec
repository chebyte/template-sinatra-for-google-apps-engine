...
Gem::Specification.new do |s|
  ...
  s.test_files = ["test/base_test.rb", "test/builder_test.rb", "test/erb_test.rb", "test/extensions_test.rb", "test/filter_test.rb", "test/haml_test.rb", "test/helpers_test.rb", "test/mapped_error_test.rb", "test/middleware_test.rb", "test/options_test.rb", "test/reload_test.rb", "test/request_test.rb", "test/response_test.rb", "test/result_test.rb", "test/routing_test.rb", "test/sass_test.rb", "test/server_test.rb", "test/sinatra_test.rb", "test/static_test.rb", "test/templates_test.rb", "test/test_test.rb"]
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::RubyGemsVersion) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<rack>, [">= 0.9.1", "< 1.0"])
    else
      s.add_dependency(%q<rack>, [">= 0.9.1", "< 1.0"])
    end
  else
    s.add_dependency(%q<rack>, [">= 0.9.1", "< 1.0"])
  end
